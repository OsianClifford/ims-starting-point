...
public class CustomerDaoMysqlTest {
	...
	static String password = "Assassin1191";
...
//	}
	...
	public static void aInit() {
		Ims ims = new Ims();
		ims.init("jdbc:mysql://localhost:3306/ims_test?serverTimezone=UTC", username, password,
	...
	public void bCreateTest() {
		CustomerDaoMysql customerDaoMysql = new CustomerDaoMysql(
				"jdbc:mysql://localhost:3306/ims_test?serverTimezone=UTC", "root", "Assassin1191");
